                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(fontSize: 12.r, fontWeight: FontWeight.w400, color: Colors.grey.shade600),
                    ),
                  ),
                ],
              ),
            ...
            SizedBox(
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      ...
                      final imageUrl = (rawImage != null && rawImage.toString() != 'null' && rawImage.toString().isNotEmpty && Uri.tryParse(rawImage.toString())?.hasScheme == true)
                          ? rawImage.toString()
                          : '';
                      return Padding(
                              ...
                              children: [
                                (imageUrl.isNotEmpty)
                                    ? CachedNetworkImage(
                                        ...
                                        placeholder: (context, url) => Container(
                                          ...
                                          child: Center(child: Image.asset("assets/images/placeholder_image.png")),
                                        ),
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text("${data?.startDate}", style: TextStyle(color: Colors.grey.shade500, fontSize: 11.r)),
                                      SizedBox(height: 4.h),
                                      Text("${data?.title}", style: TextStyle(fontSize: 14.r, fontWeight: FontWeight.w600, color: Colors.black87), maxLines: 2, overflow: TextOverflow.ellipsis),
                                    ],
                                  ),
                                ),
                              ],
